...
//      { Sid::figuredBassFontSize,     "figuredBassFontSize",     QVariant(8.0) },
      ...
      { Sid::tempoLinePlacement,         "textLinePlacement",           int(Placement::ABOVE)  },
      { Sid::tempoLinePosAbove,          "tempoLinePosAbove",           QPointF(.0, -3.5) },
      { Sid::tempoLinePosBelow,          "tempoLinePosBelow",           QPointF(.0, 3.5) },
      { Sid::tempoLineFrameType,         "tempoLineFrameType",          int(FrameType::NO_FRAME) },
      { Sid::tempoLineFramePadding,      "tempoLineFramePadding",       0.2 },
      { Sid::tempoLineFrameWidth,        "tempoLineFrameWidth",         0.1 },
      { Sid::tempoLineFrameRound,        "tempoLineFrameRound",         0 },
      { Sid::tempoLineFrameFgColor,      "tempoLineFrameFgColor",       QColor(0, 0, 0, 255) },
      { Sid::tempoLineFrameBgColor,      "tempoLineFrameBgColor",       QColor(255, 255, 255, 0) },
      { Sid::tempoLineFontFace,          "tempoLineFontFace",           "FreeSerif" },
      { Sid::tempoLineFontSize,          "tempoLineFontSize",           10.0 },
      { Sid::tempoLineFontSpatiumDependent,  "tempoLineFontSpatiumDependent", true },
      { Sid::tempoLineFontStyle,         "tempoLineFontStyle",          int(FontStyle::Normal) },
      { Sid::tempoLineColor,             "tempoLineColor",              QColor(0, 0, 0, 255) },
      { Sid::tempoLineTextAlign,         "tempoLineTextAlign",          QVariant::fromValue(Align::LEFT | Align::VCENTER) },
      ...
      { Sid::tempoLineMinDistance,          "tempoLineMinDistance",          Spatium(0.7)  },
